# Contributing to Oxdraw

This is written for anyone who wants to contribute to the Oxdraw repository.
...
- **Bug reports and issues**: Open them at <https://github.com/Quadriphobs1/oxdraw/issues>.

You can also look at our [`good first issue` tag](https://github.com/Quadriphobs1/oxdraw/labels/good%20first%20issue).
...
The main crates are found in the [`crates/`](crates) folder.
